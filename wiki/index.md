...
A persistent, compounding view of AI-in-recruitment news. Read `CLAUDE.md` for the schema and operational rules.
...
- Vendors mentioned in the corpus (Paradox, Maki, Radancy, Mega HR, Folks, Neuroscale, Recruitable) appear in stories that cluster with [[agentic-recruiting]] and [[skills-based-hiring]] but have not yet reached the second-mention threshold for individual vendor pages. Their stories are recorded in the theme timeline.
